...
-- Member event triggers are now managed by the unified triggers module.
-- Drop the old hardcoded versions so they don't conflict with user-configurable ones.
