	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if profile.HasProfilePicture || profile.HasDiscordAvatar {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 19, Col: 61}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 28, Col: 79}
			}
			...
			if profile.Pronouns != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 30, Col: 77}
				}
			...
			if profile.Bio != "" {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 39, Col: 20}
				}
			...
			if profile.DiscordUsername != "" {
				...
				if profile.HasDiscordAvatar {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 49, Col: 76}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 56, Col: 40}
				}
			...
			if profile.HasProfilePicture || profile.HasDiscordAvatar {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 73, Col: 61}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 123, Col: 31}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `modules/directory/profile.templ`, Line: 143, Col: 20}
			}
